...
def final_cart_amont(*args,discount):
    try:
        ...
        print("Please provide the amount in integer") # when error occurs print message comes first
    ...
    #                         # but once TypeError runs it wont allow below except Exception to run.
        # print(e) #print("cannot provide the cart amount") # simply print(e) will give output none for the final output after calling function
        raise e # after error gone to exception, we need raise it get it what type of error is it (eg. Typeerror, Namerror  etc..)
